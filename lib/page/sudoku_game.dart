...
import 'package:sudoku/widgets/banner_ads.dart';
          ...
          builder: (context) {
            return AlertDialog(
                title: Text(exitGameText,
                    style: TextStyle(fontWeight: FontWeight.bold).copyWith(color: Color(0xFFFF1100))),
                content: Text(exitGameContentText),
                actions: [
                  TextButton(
                    
                    child: Text(exitGameText,style: TextStyle(color: Color(0xFFFF1100)),),
            ...
            child: Expanded(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: Colors.pink,borderRadius: BorderRadius.circular(15)),
                    alignment: AlignmentDirectional.center,
                    child: Text(
                        "${LocalizationUtils.localizationLevelName(context, _state.level!)} - ${_state.timer} - ${LocalizationUtils.localizationGameStatus(context, _state.status)}",style: TextStyle(fontSize: 30,color: Colors.white),),),
              ),
          ),
 ...
 Get.put(ApiClient(sharedPreferences: Get.find()));
    ...
    _gaming();
     Timer.periodic(Duration(seconds: 30), (Timer timer) {
      ...
      // Hide the section after 20 seconds
